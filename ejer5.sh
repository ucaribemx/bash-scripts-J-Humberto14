...
# Si la variable está sin definir o vacía se muestra un error. 
#En caso contrario se le asigna un valor por defecto
 
#$variable:?valorpordefecto

echo "Valor de EJEMPLO: ${EJEMPLO:='Roberto'} y luego ${EJEMPLO}"
